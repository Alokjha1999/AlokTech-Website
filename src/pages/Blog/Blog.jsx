    ...
    <div className='blog-page'>
        <header className='height-75'>
            <div className='container h-100 d-flex flex-column align-items-center justify-content-center text-light'>
                <h1 className='text-center fw-semibold'>Tech Blog</h1>
                <p className='text-center w-75 mb-5'>Learn how to navigate the world of online financial education with ease! In this blog post.</p>
            </div>
        </header>
                    ...
                    {blogs.map((blog) => (
                        <div key={blog.id} className='col-md-6 col-lg-4'>
                            <Link to="/blog" className='text-decoration-none'>
                                <Card className='h-85 shadow scale-hover-effect bg-dark text-light border-0'>
